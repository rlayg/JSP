...
<body>
	<fmt:formatNumber value="1000000" 		groupingUsed="true" /><br> <!-- groupingUsed은 숫자를 3자리수 단위로 , 찍어줌 -->
	...
	<fmt:formatNumber value="250000"		type="currency"		currencySymbol="\\" /><br> <!-- currency는 화폐단위, \\는 원화표시 \$는 달라표시-->
